...
public class ComputerDTOPersistence {
	...
	private ComputerDTOPersistence(ComputerDTOPersistanceBuilder computerDTOPersistanceBuilder) {
		...
		this.companyDTOPersistence = computerDTOPersistanceBuilder.companyDTOPersistence;
	}
	...
	public static class ComputerDTOPersistanceBuilder {
		...
		public ComputerDTOPersistence build() {
			ComputerDTOPersistence computerDTOPersistence = new ComputerDTOPersistence(this);
			return computerDTOPersistence;
		}
	...
	public CompanyDTOPersistence getCompanyDTOPersistence() {
		return companyDTOPersistence;
	}

	public void setCompanyDTOPersistence(CompanyDTOPersistence companyDTOPersistence) {
		this.companyDTOPersistence = companyDTOPersistence;
	}
	...
	public String toString() {
		return "ComputerDTOPersistence [id=" + id + ", name=" + name + ", introduced=" + introduced + ", discontinued="
